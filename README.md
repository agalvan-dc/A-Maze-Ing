...
*   **caperale**: Designed the underlying data architecture, implemented the Recursive Backtracking generation algorithm, and built the BFS and A* pathfinding solvers.
